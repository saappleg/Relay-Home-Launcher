...
// The newest published release is v0.1.0-beta.12 (versionCode 35). Keep local debug/test builds
...
val localNextVersionCode = 36
val localNextVersionName = "0.1.0-beta.13"
